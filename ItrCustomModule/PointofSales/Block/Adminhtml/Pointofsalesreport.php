...
class ItrCustomModule_PointofSales_Block_Adminhtml_Pointofsalesreport extends Mage_Adminhtml_Block_Template
{
...

	{
		...
		$select = $connection->select()->from($pos_sales_report, array('order_id'));//->where('pos_user_name=?',$temp_id);
		...
		//echo'<pre>';print_r($sales_record);die;
