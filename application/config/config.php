...
define('ROOT', $config['base_url']);

define('HTTP_ASSETS_PATH', $config['base_url'].'assets/');
define('HTTP_CSS_PATH', $config['base_url'].'assets/css/');
define('HTTP_IMAGES_PATH', $config['base_url'].'assets/images/');
define('HTTP_PDF_THUMB_PATH', $config['base_url'].'assets/pdf_thumb/');
define('HTTP_PDF_PATH', $config['base_url'].'assets/pdf/');
