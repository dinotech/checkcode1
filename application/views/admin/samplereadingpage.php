	...
	<div class="structure-row">
        ...
        <div class="right-sec">
            ...
            <div class="content-section">
              ...
              This Page is Reading Page!!!!
            </div>
            <div style="text-align:center;margin-top:80px ;">
             <a href="<?php echo base_url(); ?>admin/magazine/manage_magz?magzid=<?php echo $_GET['magzid']  ?>" class="btn btn-info btn-lg" role="button" style=" ">Go Back To Magazine</a>
             </div>
