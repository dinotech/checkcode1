...
?>
 ...
 <div id="page-wrapper">
  <div class="row">
          <div class="col-lg-12">
            <h2><small style="color: brown;">Stock Purchase Information</small></h2>
            <hr/></div>
            </div>
 <?php
 ...
 ?>
  ...
  <a href="editstockpurchase?id=<?php echo $rows['source_id']; ?>" class="btn btn-success btn-xs">Edit</a>
  <a href="<?php echo base_url(); ?>admin/stockpurchase/delete_stockpurchase?id=<?php echo $rows['source_id']; ?>" class="btn btn-success btn-xs">Delete</a>   
 ...
 <div>
 <input id="add" type="button" class="btn btn-success" name="add" value="ADD Stock Purchase" />
 </div>
 </div>
