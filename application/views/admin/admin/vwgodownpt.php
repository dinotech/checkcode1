...
?>
 ...
 ?>
  ...
  <a href="editgodownpt?id=<?php echo $rows['g_id']; ?>" class="btn btn-success btn-xs">Edit</a>
  <a href="<?php echo base_url(); ?>admin/godownpt/delete_godown?id=<?php echo $rows['g_id']; ?>" class="btn btn-success btn-xs">Delete</a>   
