...
?>
 ...
 <div id="page-wrapper">
  <div class="row">
          <div class="col-lg-12">
            <h2><small style="color: brown;">Party Information</small></h2>
            <hr/></div>
            </div>
 <?php
 ...
 ?>
  ...
  <form action="" method="post" enctype="multipart/form-data">
      ...
      <thead>
        ...
        <!-- editdealer-->
        <a href="editparty?id=<?php echo $rows['dealer_id']; ?>" class="btn btn-success btn-xs">Edit</a>
        <a href="<?php echo base_url(); ?>admin/party/delete_dealer?id=<?php echo $rows['dealer_id']; ?>" class="btn btn-success btn-xs">Delete</a>   
 ...
 <div>
 <input id="add" type="button" class="btn btn-success" name="add" value="ADD Party" />
 </div>
 </div>
 ...
 <td><input class="form-control" type="text" name="dname" /></td></tr>
 ...
 <td><input class="form-control" type="text" name="phone" id="ph2" pattern="[0-9].{1,}" onkeyup="allnumeric(document.getElementById('ph2').value);" /></td></tr>

 <tr><th>Mobile Number:</th>
 <td><input class="form-control" type="text" name="mobile" id="mob2" pattern="[0-9].{1,}" /></td></tr>
