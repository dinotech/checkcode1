...
?>
 ...
 <div id="page-wrapper">
  <div class="row">
          <div class="col-lg-12">
            <h2><small style="color: brown;">Edit Outward Challan Information</small></h2>
            </div>
            </div>
 <hr/>
...
<form method="post" enctype="multipart/form-data" action="">
 ...
 <!--<tr><th>No. Of Bags:</th>
 <td><input class="form-control" type="number" name="bags" required="required" value="<? echo $row['no_of_begs']; ?>"/></td></tr>-->
<tr><th>No. Of Bags:</th>
...
foreach($gbq as $gbs){  ?>
 ...
 </td></tr><tr><th>Challan no.</th><td><input type="number" name="challanno" value="<?php echo $row['challanno']; ?>" /></td></tr>
