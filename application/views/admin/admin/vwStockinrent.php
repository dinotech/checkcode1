...
?>
 ...
 <div id="page-wrapper">
  <div class="row">
          <div class="col-lg-12">
            <h2><small style="color: brown;">Outward Challan</small></h2>
            <hr/></div>
            </div>
 <?php
 ...
 ?>
  ...
  <a href="editstockinrent?id=<?php echo $rows['sr_id']; ?>" class="btn btn-success btn-xs">Edit</a>
  <a href="<?php echo base_url(); ?>admin/stockinrent/delete_stockinrent?id=<?php echo $rows['sr_id']; ?>" class="btn btn-success btn-xs">Delete</a>   
 ...
 <div>
 <input id="add" type="button" class="btn btn-success" name="add" value="ADD Outword Challan" />
 </div>
 </div>
 ...
 <tr><th>Challan no.</th><td><input type="number" name="challanno" class="form-control"/></td></tr>
