...
?>
 ...
 <div id="page-wrapper">
  <div class="row">
          <div class="col-lg-12">
            <h2><small style="color: brown;">Payment Paid</small></h2>
            <hr/></div>
            </div>
 <?php
  ...
  <form action="" method="post" enctype="multipart/form-data">
      ...
      <thead>
		...
		?>
         ...
         <td><?php if($rows['payment_flow']==1){echo "Cash";}else if($rows['payment_flow']==2){echo "Cheque";}else{echo "Credit";}?></td>
         <!--<td><?php echo $rows['cur_date'];?></td>-->
         <td><h5 style="color: darkblue;cursor: pointer;">
        <!-- editdealer-->
        <a href="editpaymentp?id=<?php echo $rows['id']; ?>" class="btn btn-success btn-xs">Edit</a>
        <a href="<?php echo base_url(); ?>admin/paymentp/delete_dealer?id=<?php echo $rows['id']; ?>" class="btn btn-success btn-xs">Delete</a>   
 ...
 <div>
 <input id="add" type="button" class="btn btn-success" name="add" value="ADD Payment Paid" />
 </div>
 </div>
 ...
 <tr><th>Amount:</th>
 <td><input class="form-control" type="number" name="price"  /></td></tr>
