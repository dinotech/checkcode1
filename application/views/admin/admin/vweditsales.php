...
?>
 ...
 <div id="page-wrapper">
  <div class="row">
          <div class="col-lg-12">
            <h2><small style="color: brown;">Edit Sales Information</small></h2>
            </div>
            </div>
 <hr/>
...
<form method="post" enctype="multipart/form-data" action="">
 ...
 <tr><th>Price:</th>
 <td>
 <input class="form-control" type="number" required="required" pattern="[0-9].{1,}" name="price" value="<? echo $row['prices']; ?>"/></td></tr>
 
 <!--<tr><th>No. Of Bags:</th>
 <td><input class="form-control" type="number" required="required" name="bags" value="<? echo $row['no_of_bags']; ?>"/></td></tr>-->
<tr><th>No. Of Bags:</th>
 <!--<td><input class="form-control" type="number" name="bags" /></td></tr>-->
<td><input class="form-control" step="any" type="number" name="bags" value="<? echo $row['no_of_bags']; ?>" id="textBox"/></td><th>Metric ton</th><td><input type="number" step="any" id="message" value="<?php echo $row['metricton']; ?>"name="metricton"/></td>
