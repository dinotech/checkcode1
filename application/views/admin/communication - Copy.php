...
$headers .= 'From: '.'abcd.com'."\r\n".
    'Reply-To: '.'mailabcd@efgh.com'."\r\n" .
...
mail('abc.com', 'Hello', 'hi there', 'efgh.com');
?><head>
<?php  $this->load->view('admin/my_header.php');?>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>                                        	
                                            ...
                                            <td class="col-md-8"><input type="text" name="freq" value="" placeholder="Enter Magazine Frequency" class="form-control"></td>
                                        </tr>
                                        <tr>                                        	
