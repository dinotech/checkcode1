...
<tbody>
<tr>
<td><label  class="form_control">E-mail id </label> </td>
...
<div class="col-xs-6">   
		<select id="1mag<?php echo $i?>" name="submag" class="form-control" onchange="magprice0(this.id)">	
				...
				<?php  
//print_r($subscriber[$i]['email_id']);die;
...
<?php  if(trim($this->session->userdata['role'])=='franchise'){ ?>
...
<?php if($this->session->userdata['role']=='franchise'){ ?>
...
<div class="col-sm-12" style="min-height: 30px;">
		<label for="inputAmount" class="col-sm-3 control-label">Amount:</label>
		<div class="col-sm-8">
				 <input type="text"  class="form-control " name="amount" readonly="readonly" id="inputAmountq<?php echo ($i+1); echo $i?>" placeholder="Amount"  >
		</div>
</div>     
<div class="col-sm-12" style="min-height: 30px;">
		<label for="inputSendername" class="col-sm-3 control-label">Sender name:</label>
...
<label for="inputAmount" class="col-sm-3 control-label">Amount:</label>
<div class="col-sm-8">
<input type="text"  class="form-control " name="amount" readonly="readonly" id="inputAmountq<?php echo ($i+1); echo $i;echo $i;?>" placeholder="Amount"  >
</div>
</div>
...
<div class="col-sm-12"  style="min-height: 30px;">
	<label for="inputAmount" class="col-sm-3 control-label">Amount</label>
	<div class="col-sm-8">
			<input type="text"  class="form-control " name="Amount" readonly="readonly" id="inputAmountq<?php echo ($i+1); echo $i;echo $i;echo $i;?>" placeholder="Amount"  >
	</div>
</div> 
</div><?php } ?>
...
$('#inputAmountq'+data1+data2).val($("#total"+data2).val());
$('#inputAmountq'+data1+data2+data2).val($("#total"+data2).val());
$('#inputAmountq'+data1+data2+data2+data2).val($("#total"+data2).val());
